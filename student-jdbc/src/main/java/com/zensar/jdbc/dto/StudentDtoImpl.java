...
public abstract class StudentDtoImpl implements StudentDto {
	...
	public int insertStudent(Student student) {
		...
		int r = this.jdbcTemplate.update(query, student.getStudentId(), student.getStudentName(),
	...
	public int updateStudent(Student student) {
		...
		int r = this.jdbcTemplate.update(query, student.getStudentName(), student.getRollNumber(),
